...
USAGES = {
    TOP_SENDERS: {
        "actif": True,
        "args": {"short": "-ts", "long": "--{}".format(TOP_SENDERS)},
        "kwargs": {
            "nargs": "?",
            "type": int,
            "const": 10,
    ...
    LIST_BOXES: {
        "actif": True,
        "args": {"short": "-b", "long": "--{}".format(LIST_BOXES)},
        "kwargs": {
            "action": "store_true",
    ...
    SELECT_BOX: {
        "actif": True,
        "args": {"short": "-sb", "long": "--{}".format(SELECT_BOX)},
        "kwargs": {
            "nargs": 1,
            "type": int,
    ...
    LAST_EMAIL: {
        "actif": False,
        "args": {"short": "-le", "long": "--last-emails"},
        "kwargs": {
            "nargs": "?",
            "type": int,
            "const": 10,
    ...
    RECEIVED_FROM: {
        "actif": True,
        "args": {"short": "-f", "long": "--{}".format(RECEIVED_FROM)},
        "kwargs": {
            "nargs": 1,
            "type": str,
    ...
    SENT_TO: {
        "actif": True,
        "args": {"short": "-t", "long": "--{}".format(SENT_TO)},
        "kwargs": {
            "nargs": 1,
            "type": str,
    ...
    READ_EMAIL: {
        "actif": True,
        "args": {"short": "-r", "long": "--{}".format(READ_EMAIL)},
        "kwargs": {
            "nargs": 1,
            "type": int,
    ...
    DELETE_ID: {
        "actif": True,
        "args": {"short": "-di", "long": "--{}".format(DELETE_ID)},
        "kwargs": {
            "nargs": "+",
            "type": int,
    ...
    DELETE_FROM: {
        "actif": True,
        "args": {"short": "-df", "long": "--{}".format(DELETE_FROM)},
        "kwargs": {
            "nargs": "+",
            "type": str,
    ...
    DELETE_CACHE: {
        "actif": True,
        "args": {"short": "-dc", "long": "--{}".format(DELETE_CACHE)},
        "kwargs": {
            "action": "store_true",
    ...
    RESET: {
        "actif": True,
        "args": {"short": "-rc", "long": "--{}".format(RESET)},
        "kwargs": {"action": "store_true", "help": "Reset all connections"},
    },
    LOGOUT: {
        "actif": True,
        "args": {"short": "-q", "long": "--{}".format(LOGOUT)},
        "kwargs": {
            "action": "store_true",
